...
export default class DetailPresenter {
    ...
    async saveStory() {
        try {
            ...
            this.#view.saveToSavedSuccessfully('Success to save to bookmark');
        } catch (error) {
            console.error('saveStory: error', error);
            this.#view.saveToSavedFailed(error.message);
        }
    }
    ...
    async removeStory() {
        try {
            ...
            this.#view.removeFromSavedSuccessfully('Success to remove from bookmark');
        } catch (error) {
            console.error('removeStory: error', error);
            this.#view.removeFromSavedFailed(error.message);
        }
    }
