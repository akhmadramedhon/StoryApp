import AddPagePresenter from "./additional-functions";
        ...
        return `
            <section>
                <div class="new-story__header">
                    <div class="container">
                        <h1 class="new-story__header__title">Buat Story Perjalanan Anda</h1>
                    </div>
                </div>
            </section>
                ...
                <div class="new-form__container">
                    <form id="new-form" class="new-form">
                        <div class="form-control">
                          ...
                          <div id="image-more-info">Sertakan foto sebagai dokumentasi.</div>
