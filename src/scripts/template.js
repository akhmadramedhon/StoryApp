...
export function generateUnauthenticatedNavigationListTemplate() {
    return `
        <li> <a id="login-button" class="btn" href="#/login">Login</a></li>
        <li> <a id="register-button" class="btn" href="#/register">Register</a></li>
    `;
}
...
export function generateAuthenticatedNavigationListTemplate() {
    return `
        ...
        <li> <a id="saved-button" class="btn saved-button" href="#/saved">Tersimpan</a></li>
        <li> <a id="new-story-button" class="btn new-story-button" href="#/new">Posting</a></li>
        ...
        <div class="container">
            <div class="story-detail__body">
                <div class="story-detail__more-info">
                    ...
                    <div class="story-detail__more-info__inline">
                      <div id="location-latitude" class="story-detail__location__latitude" data-value="${location.latitude ?? 'Lintang tidak ada'}">Lintang:</div>
                      <div id="location-longitude" class="story-detail__location__longitude" data-value="${location.longitude ?? 'Bujur tidak ada'}">Bujur:</div>
                    </div>
